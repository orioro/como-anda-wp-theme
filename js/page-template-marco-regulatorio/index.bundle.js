	...
	*/
	...
	var ChevronDownIcon = function ChevronDownIcon(_ref) {
	  ...
	  return React.createElement(
	    'svg',
	    _extends$1({}, props, { className: className, width: size, height: size, fill: color, viewBox: '0 0 24 24' }),
	...
	function (_React$Component) {
	  ...
	  _createClass(OptionList, [{
	    key: "calculateOptionContainerWidth",
	    value: function calculateOptionContainerWidth() {
	      var listItemElements = this.optionContainerRef.current.querySelectorAll('li');
	      var first = listItemElements[0];
	      var last = listItemElements[listItemElements.length - 1];
	    ...
	    value: function render() {
	      ...
	      return react.createElement("div", {
	      ...
	      }, heading ? react.createElement("h3", null, heading) : null, react.createElement("ul", {
	        ...
	        return react.createElement("li", {
	          key: option.id
	        }, react.createElement(Option, _extends({}, option, {
	...
	var OptionsPanel = function OptionsPanel(_ref) {
	  ...
	  return react.createElement("div", {
	    ...
	    return react.createElement("li", {
	      key: list.id
	    }, react.createElement(OptionList, _extends({}, list, {
	  ...
	  return react.createElement("div", {
	    ...
	    return react.createElement("li", {
	      ...
	      render: function render() {
	        return react.createElement(OptionsPanel, _extends({}, parameter, {
	...
	var generateOptions = function generateOptions(quantity) {
	  var prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
	  return new Array(quantity).fill(0).map(function (item, index) {
	    return {
	      id: "".concat(prefix, "--option-").concat(index),
	      label: "".concat(prefix, "--option-").concat(index),
	      value: false
	    };
	  });
	};

	var makeOptionFromString = function makeOptionFromString(str) {
	  return {
	    id: str,
	    label: str,
	    value: false
	...
	var FILTER_PARAMETERS = [{
	  ...
	  optionLists: [{
	    id: 'list-1',
	    options: ['Acessibilidade', 'Acesso ao lote', 'Arborização', 'Atividades comerciais (usos externos de restaurante, ambulantes)', 'Conduta', 'Esquina', 'Execução e Manutenção das calçadas'].map(makeOptionFromString)
	  }, {
	    id: 'list-2',
	    options: ['Governança', 'Inclinação da calçada', 'Interferências e Mobiliário Urbano', 'Largura da calçada', 'Moderação de tráfego', 'Modo de transporte não motorizado', 'Obras e instalação de infraestrutura'].map(makeOptionFromString)
	  }]
	}];
	document.addEventListener('DOMContentLoaded', function (e) {
	  reactDom_1(react.createElement(Filter, {
	    parameters: FILTER_PARAMETERS,
	    onParameterSelectAll: function onParameterSelectAll(parameterId) {
	      console.log('onParameterSelectAll', parameterId);
	    },
	    onParameterDeselectAll: function onParameterDeselectAll(parameterId) {
